/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 6d9e612296d76d63dd4a31f33540c321)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		NEXT_PUBLIC_API_PROTO: string;
		NEXT_PUBLIC_API_HOST: string;
		NEXT_PUBLIC_WEB_PROTO: string;
		NEXT_PUBLIC_WEB_HOST: string;
		GITHUB_TOKEN: string;
		CRATESIO_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_PUBLIC_API_PROTO" | "NEXT_PUBLIC_API_HOST" | "NEXT_PUBLIC_WEB_PROTO" | "NEXT_PUBLIC_WEB_HOST" | "GITHUB_TOKEN" | "CRATESIO_TOKEN" | "CODEBERG_TOKEN">> {}
}
